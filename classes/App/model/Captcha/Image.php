...
class App_Captcha_Image extends App_Captcha_Word
{
    /**
     ...
     * @var string
     */
    protected $_imgUrl = "/public/captcha/";
   ...
   /**
    ...
    protected function _generateImage($id, $word)
    {
        if (!extension_loaded("gd")) {
            throw new App_Captcha_Exception("Image CAPTCHA requires GD extension");
        }
        if (!function_exists("imagepng")) {
            throw new App_Captcha_Exception("Image CAPTCHA requires PNG support");
        }
        if (!function_exists("imageftbbox")) {
            throw new App_Captcha_Exception("Image CAPTCHA requires FT fonts support");
        }

        $font = $this->getFont();

        if (empty($font)) {
            throw new App_Captcha_Exception("Image CAPTCHA requires font");
        }
        ...
        if(empty($this->_startImage)) {
            ...
            if(!$img) {
                ...
                throw new App_Captcha_Exception("Can not load start image");
            }
            $w = imagesx($img);
            $h = imagesy($img);
        }
