...
class DBx_Profiler_Query
{
    ...
    /**
     * One of the DBx_Profiler constants for query type, set by $queryType argument in constructor.
     *
     * @var integer
     */
     ...
     * type (one of the DBx_Profiler::* constants).
     *
     * @param  string  $query
    ...
    /**
     * Get the type of this query (one of the DBx_Profiler::* constants)
     *
     * @return integer
     */
