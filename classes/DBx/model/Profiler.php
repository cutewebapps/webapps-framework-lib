...
class DBx_Profiler
{
    ...
    /**
     * Array of DBx_Profiler_Query objects.
     *
     * @var array
     */
     ...
     * @return DBx_Profiler Provides a fluent interface
     */
     ...
     * the DBx_Profiler::* constants to only save profiles for that type of
     ...
     *
     * @return integer|null
     * @see    DBx_Profiler::setFilterQueryType()
     */
     ...
     */
    public function queryClone(DBx_Profiler_Query $query)
    {
    ...
    /**
     * Starts a query.  Creates a new query profile object (DBx_Profiler_Query)
     ...
     * @param  integer $queryType   OPTIONAL Type of query, one of the DBx_Profiler::* constants
     * @return integer|null
     */
    public function queryStart($queryText, $queryType = null)
    {
        ...
        /**
         * @see DBx_Profiler_Query
         */
        $this->_queryProfiles[] = new DBx_Profiler_Query($queryText, $queryType);
     ...
     *
     * @param  integer $queryId
     * @throws DBx_Profiler_Exception
     * @return void
     */
    public function queryEnd($queryId)
    {
        // Don't do anything if the DBx_Profiler is not enabled.
        if (!$this->_enabled) {
            return self::IGNORED;
        }
        ...
        if (!isset($this->_queryProfiles[$queryId])) {
            /**
             * @see DBx_Profiler_Exception
             */
            throw new DBx_Profiler_Exception("Profiler has no query with handle '$queryId'.");
        }
        ...
        if ($qp->hasEnded()) {
             ...
             * @see DBx_Profiler_Exception
             */
            throw new DBx_Profiler_Exception("Query with profiler handle '$queryId' has already ended.");
        }
     ...
     * by queryStart() and it will return a DBx_Profiler_Query object.
     *
     * @param  integer $queryId
     * @throws DBx_Profiler_Exception
     * @return DBx_Profiler_Query
     */
    public function getQueryProfile($queryId)
    {
        if (!array_key_exists($queryId, $this->_queryProfiles)) {
             ...
             * @see DBx_Profiler_Exception
             */
            throw new DBx_Profiler_Exception("Query handle '$queryId' not found in profiler log.");
        }
    ...
    /**
     * Get an array of query profiles (DBx_Profiler_Query objects).  If $queryType
     * is set to one of the DBx_Profiler::* constants then only queries of that
     ...
     * one or more of the DBx_Profiler::* constants, the elapsed time will be calculated
     ...
     * be counted.  If $queryType is set to one of the DBx_Profiler::* constants, only queries of
    ...
    /**
     * Get the DBx_Profiler_Query object for the last query that was run, regardless if it has
     * ended or not.  If the query has not ended, its end time will be null.  If no queries have
     * been profiled, false is returned.
     *
     * @return DBx_Profiler_Query|false
     */
