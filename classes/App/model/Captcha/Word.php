...
abstract class App_Captcha_Word extends App_Captcha_Base
{
    /**#@+
     ...
     * @var string
     */
    protected $_sessionClass = 'App_Session_Namespace';
    ...
    public function getSession()
    {
        if (!isset($this->_session) || (null === $this->_session)) {
            $id = $this->getId();
            $this->_session = new $this->_sessionClass( 'App_Form_Captcha_' . $id );
     ...
     * @return App_Captcha_Word
     */
    public function setSession(App_Session_Namespace $session)
    {
     ...
     * Validate the word
     *
     * @see    App_Validate_Interface::isValid()
     * @param  mixed $value
     * @return boolean
     */
